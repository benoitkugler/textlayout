// Generated by tools/main.go
// DO NOT EDIT

// Indic data from : https://unicode.org/Public/UCD/latest/ucd/IndicSyllabicCategory.txt
// Emoji data from : https://www.unicode.org/Public/emoji/12.0/emoji-data.txt
// Breaks data from : https://www.unicode.org/Public/12.0.0/ucd/LineBreak.txt
...
var _Virama = &unicode.RangeTable{
	R16: []unicode.Range16{
...
var _Vowel_Dependent = &unicode.RangeTable{
	R16: []unicode.Range16{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1122c, Hi: 0x11233, Stride: 1},
...
var _Emoji = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x26ab, Hi: 0x26b0, Stride: 5},
		{Lo: 0x26b1, Hi: 0x26bd, Stride: 12},
		{Lo: 0x26be, Hi: 0x26c4, Stride: 6},
		{Lo: 0x26c5, Hi: 0x26c8, Stride: 3},
		{Lo: 0x26ce, Hi: 0x26cf, Stride: 1},
		{Lo: 0x26d1, Hi: 0x26d3, Stride: 2},
...
var _Emoji_Presentation = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1f6d5, Hi: 0x1f6eb, Stride: 22},
		{Lo: 0x1f6ec, Hi: 0x1f6f4, Stride: 8},
		{Lo: 0x1f6f5, Hi: 0x1f6fa, Stride: 1},
		{Lo: 0x1f7e0, Hi: 0x1f7eb, Stride: 1},
		{Lo: 0x1f90d, Hi: 0x1f93a, Stride: 1},
		{Lo: 0x1f93c, Hi: 0x1f945, Stride: 1},
		{Lo: 0x1f947, Hi: 0x1f971, Stride: 1},
...
var _Emoji_Modifier_Base = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1f90f, Hi: 0x1f918, Stride: 9},
		{Lo: 0x1f919, Hi: 0x1f91f, Stride: 1},
		...
		{Lo: 0x1f9bb, Hi: 0x1f9cd, Stride: 18},
		{Lo: 0x1f9ce, Hi: 0x1f9cf, Stride: 1},
...
var _Extended_Pictographic = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1f93c, Hi: 0x1f945, Stride: 1},
		{Lo: 0x1f947, Hi: 0x1fffd, Stride: 1},
	},
	LatinOffset: 1,
}
...
var _AL = &unicode.RangeTable{
	R16: []unicode.Range16{
		...
		{Lo: 0x2e4d, Hi: 0x4dc0, Stride: 8051},
		{Lo: 0x4dc1, Hi: 0x4dff, Stride: 1},
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x11144, Hi: 0x11150, Stride: 12},
		...
		{Lo: 0x1145f, Hi: 0x11480, Stride: 33},
		{Lo: 0x11481, Hi: 0x114af, Stride: 1},
...
var _ID = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x1fa54, Hi: 0x1fffd, Stride: 1},
...
var _BA = &unicode.RangeTable{
	...
	R32: []unicode.Range32{
		...
		{Lo: 0x115c3, Hi: 0x115c9, Stride: 6},
		{Lo: 0x115ca, Hi: 0x115d7, Stride: 1},
