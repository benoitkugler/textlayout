...
var ot_languages = [...]LangTag{
	...
	{"aao", 0x4152410},  /* Algerian Saharan Arabic -> Arabic */
...
// conversion.
func hb_ot_tags_from_complex_language(langStr string, limit int) []hb_tag_t {
	if subtagMatches(langStr, limit, "fonnapa") {
		/* Undetermined; North American Phonetic Alphabet */

		return []hb_tag_t{0x41505048} /*  */
	}
	if subtagMatches(langStr, limit, "fonipa") {
		/* Undetermined; International Phonetic Alphabet */

		return []hb_tag_t{0x49505048} /*  */
	}
	if subtagMatches(langStr, limit, "geok") {
		/* Undetermined;  */

		return []hb_tag_t{0x4b474520} /* Khutsuri Georgian */
	}
	if subtagMatches(langStr, limit, "syre") {
		/* Undetermined;  */

		return []hb_tag_t{0x53595245} /* Syriac, Estrangela script-variant (equivalent to ISO 15924 'Syre') */
	}
	if subtagMatches(langStr, limit, "syrj") {
		/* Undetermined;  */

		return []hb_tag_t{0x5359524a} /* Syriac, Western script-variant (equivalent to ISO 15924 'Syrj') */
	}
	if subtagMatches(langStr, limit, "syrn") {
		/* Undetermined;  */

		return []hb_tag_t{0x5359524e} /* Syriac, Eastern script-variant (equivalent to ISO 15924 'Syrn') */
	}
	...
	case 'a':
		if langStr[1:] == "rt-lojban" {
			...
			return []hb_tag_t{0x4a424f20} /* Lojban */
		}

	case 'c':
		if langMatches(langStr[1:], "do-hant-hk") {
			/* Min Dong Chinese; ; Hong Kong */
			return []hb_tag_t{0x5a484820} /* Chinese, Traditional, Hong Kong SAR */
		}
		...
		if langMatches(langStr[1:], "do-hans") {
			/* Min Dong Chinese;  */
			return []hb_tag_t{0x5a485320} /* Chinese, Simplified */
		}
		if langMatches(langStr[1:], "do-hant") {
			/* Min Dong Chinese;  */
			return []hb_tag_t{0x5a485420} /* Chinese, Traditional */
		}
	...
	case 'e':
		if strings.HasPrefix(langStr[1:], "l-") &&
			...
			return []hb_tag_t{0x50475220} /* Polytonic Greek */
		}
	...
	case 'g':
		...
		if langMatches(langStr[1:], "a-latg") {
			/* Irish;  */
			return []hb_tag_t{0x49525420} /* Irish Traditional */
		}
	...
	case 'h':
		...
		if strings.HasPrefix(langStr[1:], "y-") &&
			...
			return []hb_tag_t{0x48594520} /* Armenian */
		}
	...
	case 'i':
		...
		if langStr[1:] == "-lux" {
			...
			return []hb_tag_t{0x4c545a20} /* Luxembourgish */
		}
	...
	case 'n':
		...
		if langStr[1:] == "o-bok" {
			...
			return []hb_tag_t{0x4e4f5220} /* Norwegian */
		}
		if langStr[1:] == "o-nyn" {
	...
	case 'o':
		if strings.HasPrefix(langStr[1:], "c-") &&
			...
			return []hb_tag_t{0x50524f20} /* Provençal / Old Provençal */
		}
	...
	case 'r':
		if strings.HasPrefix(langStr[1:], "o-") &&
			...
			/* Romanian; Moldova */
			return []hb_tag_t{0x4d4f4c20} /* Moldavian */
		}
...
// in 'ot_languages'.
func hb_ot_ambiguous_tag_to_language(tag hb_tag_t) common.Language {
	switch tag {
	case 0x414c5420: /* Altai */
		return hb_language_from_string("alt") /* Southern Altai */
	case 0x41505048: /*  */
		return hb_language_from_string("und-fonnapa") /* Undetermined; North American Phonetic Alphabet */
	case 0x41524120: /* Arabic */
		return hb_language_from_string("ar") /* Arabic [macrolanguage] */
	case 0x41524b20: /* Rakhine */
		return hb_language_from_string("rki") /* Rakhine */
	case 0x41544820: /* Athapaskan */
		return hb_language_from_string("ath") /* Athapascan [family] */
	case 0x42425220: /* Berber */
		return hb_language_from_string("ber") /* Berber [family] */
	case 0x42494b20: /* Bikol */
		return hb_language_from_string("bik") /* Bikol [macrolanguage] */
	case 0x42544b20: /* Batak */
		return hb_language_from_string("btk") /* Batak [family] */
	case 0x43505020: /* Creoles */
		return hb_language_from_string("crp") /* Creoles and pidgins [family] */
	case 0x43525220: /* Carrier */
		return hb_language_from_string("crx") /* Carrier */
	case 0x44475220: /* Dogri (macrolanguage) */
		return hb_language_from_string("doi") /* Dogri [macrolanguage] */
	case 0x444e4b20: /* Dinka */
		return hb_language_from_string("din") /* Dinka [macrolanguage] */
	case 0x44524920: /* Dari */
		return hb_language_from_string("prs") /* Dari */
	case 0x445a4e20: /* Dzongkha */
		return hb_language_from_string("dz") /* Dzongkha */
	case 0x45544920: /* Estonian */
		return hb_language_from_string("et") /* Estonian [macrolanguage] */
	case 0x46415220: /* Persian */
		return hb_language_from_string("fa") /* Persian [macrolanguage] */
	case 0x474f4e20: /* Gondi */
		return hb_language_from_string("gon") /* Gondi [macrolanguage] */
	case 0x484d4e20: /* Hmong */
		return hb_language_from_string("hmn") /* Hmong [macrolanguage] */
	case 0x484e4420: /* Hindko */
		return hb_language_from_string("hnd") /* Southern Hindko */
	case 0x48594520: /* Armenian */
		return hb_language_from_string("hyw") /* Western Armenian */
	case 0x494a4f20: /* Ijo */
		return hb_language_from_string("ijo") /* Ijo [family] */
	case 0x494e5520: /* Inuktitut */
		return hb_language_from_string("iu") /* Inuktitut [macrolanguage] */
	case 0x49504b20: /* Inupiat */
		return hb_language_from_string("ik") /* Inupiaq [macrolanguage] */
	case 0x49505048: /*  */
		return hb_language_from_string("und-fonipa") /* Undetermined; International Phonetic Alphabet */
	case 0x49525420: /* Irish Traditional */
		return hb_language_from_string("ga-Latg") /* Irish;  */
	case 0x4a494920: /* Yiddish */
		return hb_language_from_string("yi") /* Yiddish [macrolanguage] */
	case 0x4b414c20: /* Kalenjin */
		return hb_language_from_string("kln") /* Kalenjin [macrolanguage] */
	case 0x4b474520: /* Khutsuri Georgian */
		return hb_language_from_string("und-Geok") /* Undetermined;  */
	case 0x4b4e5220: /* Kanuri */
		return hb_language_from_string("kr") /* Kanuri [macrolanguage] */
	case 0x4b4f4820: /* Korean Old Hangul */
		return hb_language_from_string("okm") /* Middle Korean (10th-16th cent.) */
	case 0x4b4f4b20: /* Konkani */
		return hb_language_from_string("kok") /* Konkani [macrolanguage] */
	case 0x4b4f4d20: /* Komi */
		return hb_language_from_string("kv") /* Komi [macrolanguage] */
	case 0x4b504c20: /* Kpelle */
		return hb_language_from_string("kpe") /* Kpelle [macrolanguage] */
	case 0x4b524e20: /* Karen */
		return hb_language_from_string("kar") /* Karen [family] */
	case 0x4b554920: /* Kui */
		return hb_language_from_string("uki") /* Kui (India) */
	case 0x4b555220: /* Kurdish */
		return hb_language_from_string("ku") /* Kurdish [macrolanguage] */
	case 0x4c554820: /* Luyia */
		return hb_language_from_string("luy") /* Luyia [macrolanguage] */
	case 0x4c564920: /* Latvian */
		return hb_language_from_string("lv") /* Latvian [macrolanguage] */
	case 0x4d415720: /* Marwari */
		return hb_language_from_string("mwr") /* Marwari [macrolanguage] */
	case 0x4d4c4720: /* Malagasy */
		return hb_language_from_string("mg") /* Malagasy [macrolanguage] */
	case 0x4d4c5920: /* Malay */
		return hb_language_from_string("ms") /* Malay [macrolanguage] */
	case 0x4d4e4720: /* Mongolian */
		return hb_language_from_string("mn") /* Mongolian [macrolanguage] */
	case 0x4d4e4b20: /* Maninka */
		return hb_language_from_string("man") /* Mandingo [macrolanguage] */
	case 0x4d4f4c20: /* Moldavian */
		return hb_language_from_string("ro-MD") /* Romanian; Moldova */
	case 0x4d594e20: /* Mayan */
		return hb_language_from_string("myn") /* Mayan [family] */
	case 0x4e414820: /* Nahuatl */
		return hb_language_from_string("nah") /* Nahuatl [family] */
	case 0x4e455020: /* Nepali */
		return hb_language_from_string("ne") /* Nepali [macrolanguage] */
	case 0x4e495320: /* Nisi */
		return hb_language_from_string("njz") /* Nyishi */
	case 0x4e4f5220: /* Norwegian */
		return hb_language_from_string("no") /* Norwegian [macrolanguage] */
	case 0x4f4a4220: /* Ojibway */
		return hb_language_from_string("oj") /* Ojibwa [macrolanguage] */
	case 0x4f524f20: /* Oromo */
		return hb_language_from_string("om") /* Oromo [macrolanguage] */
	case 0x50415320: /* Pashto */
		return hb_language_from_string("ps") /* Pashto [macrolanguage] */
	case 0x50475220: /* Polytonic Greek */
		return hb_language_from_string("el-polyton") /* Modern Greek (1453-); Polytonic Greek */
	case 0x50524f20: /* Provençal / Old Provençal */
		return hb_language_from_string("pro") /* Old Provençal (to 1500) */
	case 0x51554820: /* Quechua (Bolivia) */
		return hb_language_from_string("quh") /* South Bolivian Quechua */
	case 0x51555a20: /* Quechua */
		return hb_language_from_string("qu") /* Quechua [macrolanguage] */
	case 0x51564920: /* Quechua (Ecuador) */
		return hb_language_from_string("qvi") /* Imbabura Highland Quichua */
	case 0x51574820: /* Quechua (Peru) */
		return hb_language_from_string("qwh") /* Huaylas Ancash Quechua */
	case 0x52414a20: /* Rajasthani */
		return hb_language_from_string("raj") /* Rajasthani [macrolanguage] */
	case 0x524f5920: /* Romany */
		return hb_language_from_string("rom") /* Romany [macrolanguage] */
	case 0x53514920: /* Albanian */
		return hb_language_from_string("sq") /* Albanian [macrolanguage] */
	case 0x53524220: /* Serbian */
		return hb_language_from_string("sr") /* Serbian */
	case 0x53595220: /* Syriac */
		return hb_language_from_string("syr") /* Syriac [macrolanguage] */
	case 0x53595245: /* Syriac, Estrangela script-variant (equivalent to ISO 15924 'Syre') */
		return hb_language_from_string("und-Syre") /* Undetermined;  */
	case 0x5359524a: /* Syriac, Western script-variant (equivalent to ISO 15924 'Syrj') */
		return hb_language_from_string("und-Syrj") /* Undetermined;  */
	case 0x5359524e: /* Syriac, Eastern script-variant (equivalent to ISO 15924 'Syrn') */
		return hb_language_from_string("und-Syrn") /* Undetermined;  */
	case 0x544d4820: /* Tamashek */
		return hb_language_from_string("tmh") /* Tamashek [macrolanguage] */
	case 0x544f4420: /* Todo */
		return hb_language_from_string("xwo") /* Written Oirat */
	case 0x5a484820: /* Chinese, Traditional, Hong Kong SAR */
		return hb_language_from_string("zh-HK") /* Chinese [macrolanguage]; Hong Kong */
	case 0x5a485320: /* Chinese, Simplified */
		return hb_language_from_string("zh-Hans") /* Chinese [macrolanguage];  */
	case 0x5a485420: /* Chinese, Traditional */
		return hb_language_from_string("zh-Hant") /* Chinese [macrolanguage];  */
	case 0x5a48544d: /* Chinese, Traditional, Macao SAR */
		return hb_language_from_string("zh-MO") /* Chinese [macrolanguage]; Macao */
	case 0x5a5a4120: /* Zazaki */
		return hb_language_from_string("zza") /* Zazaki [macrolanguage] */
	default:
		return ""
	}
}
