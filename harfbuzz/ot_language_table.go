...
// conversion.
func tagsFromComplexLanguage(langStr string, limit int) []truetype.Tag {
	if subtagMatches(langStr, limit, "fonnapa") {
		/* Undetermined; North American Phonetic Alphabet */

		return []truetype.Tag{0x41505048} /*  */
	}
	if subtagMatches(langStr, limit, "fonipa") {
		/* Undetermined; International Phonetic Alphabet */

		return []truetype.Tag{0x49505048} /*  */
	}
	if subtagMatches(langStr, limit, "geok") {
		/* Undetermined;  */

		return []truetype.Tag{0x4b474520} /* Khutsuri Georgian */
	}
	if subtagMatches(langStr, limit, "syre") {
		/* Undetermined;  */

		return []truetype.Tag{0x53595245} /* Syriac, Estrangela script-variant (equivalent to ISO 15924 'Syre') */
	}
	if subtagMatches(langStr, limit, "syrj") {
		/* Undetermined;  */

		return []truetype.Tag{0x5359524a} /* Syriac, Western script-variant (equivalent to ISO 15924 'Syrj') */
	}
	if subtagMatches(langStr, limit, "syrn") {
		/* Undetermined;  */

		return []truetype.Tag{0x5359524e} /* Syriac, Eastern script-variant (equivalent to ISO 15924 'Syrn') */
	}
	...
	case 'a':
		if langStr[1:] == "rt-lojban" {
			...
			return []truetype.Tag{0x4a424f20} /* Lojban */
		}

	case 'c':
		if langMatches(langStr[1:], "do-hant-hk") {
			/* Min Dong Chinese; ; Hong Kong */
			return []truetype.Tag{0x5a484820} /* Chinese, Traditional, Hong Kong SAR */
		}
		...
		if langMatches(langStr[1:], "do-hans") {
			/* Min Dong Chinese;  */
			return []truetype.Tag{0x5a485320} /* Chinese, Simplified */
		}
		if langMatches(langStr[1:], "do-hant") {
			/* Min Dong Chinese;  */
			return []truetype.Tag{0x5a485420} /* Chinese, Traditional */
		}
	...
	case 'e':
		if strings.HasPrefix(langStr[1:], "l-") &&
			...
			return []truetype.Tag{0x50475220} /* Polytonic Greek */
		}
	...
	case 'g':
		...
		if langMatches(langStr[1:], "a-latg") {
			/* Irish;  */
			return []truetype.Tag{0x49525420} /* Irish Traditional */
		}
	...
	case 'h':
		...
		if strings.HasPrefix(langStr[1:], "y-") &&
			...
			return []truetype.Tag{0x48594520} /* Armenian */
		}
	...
	case 'i':
		...
		if langStr[1:] == "-lux" {
			...
			return []truetype.Tag{0x4c545a20} /* Luxembourgish */
		}
	...
	case 'n':
		...
		if langStr[1:] == "o-bok" {
			...
			return []truetype.Tag{0x4e4f5220} /* Norwegian */
		}
		if langStr[1:] == "o-nyn" {
	...
	case 'o':
		if strings.HasPrefix(langStr[1:], "c-") &&
			...
			return []truetype.Tag{0x50524f20} /* Provençal / Old Provençal */
		}
	...
	case 'r':
		if strings.HasPrefix(langStr[1:], "o-") &&
			...
			/* Romanian; Moldova */
			return []truetype.Tag{0x4d4f4c20} /* Moldavian */
		}
...
func ambiguousTagToLanguage(tag truetype.Tag) Language {
	...
	case 0x414c5420: /* Altai */
		return NewLanguage("alt") /* Southern Altai */
	case 0x41505048: /*  */
		return NewLanguage("und-fonnapa") /* Undetermined; North American Phonetic Alphabet */
	case 0x41524120: /* Arabic */
		return NewLanguage("ar") /* Arabic [macrolanguage] */
	case 0x41524b20: /* Rakhine */
		return NewLanguage("rki") /* Rakhine */
	case 0x41544820: /* Athapaskan */
		return NewLanguage("ath") /* Athapascan [family] */
	case 0x42425220: /* Berber */
		return NewLanguage("ber") /* Berber [family] */
	case 0x42494b20: /* Bikol */
		return NewLanguage("bik") /* Bikol [macrolanguage] */
	case 0x42544b20: /* Batak */
		return NewLanguage("btk") /* Batak [family] */
	case 0x43505020: /* Creoles */
		return NewLanguage("crp") /* Creoles and pidgins [family] */
	case 0x43525220: /* Carrier */
		return NewLanguage("crx") /* Carrier */
	case 0x44475220: /* Dogri (macrolanguage) */
		return NewLanguage("doi") /* Dogri [macrolanguage] */
	case 0x444e4b20: /* Dinka */
		return NewLanguage("din") /* Dinka [macrolanguage] */
	case 0x44524920: /* Dari */
		return NewLanguage("prs") /* Dari */
	case 0x445a4e20: /* Dzongkha */
		return NewLanguage("dz") /* Dzongkha */
	case 0x45544920: /* Estonian */
		return NewLanguage("et") /* Estonian [macrolanguage] */
	case 0x46415220: /* Persian */
		return NewLanguage("fa") /* Persian [macrolanguage] */
	case 0x474f4e20: /* Gondi */
		return NewLanguage("gon") /* Gondi [macrolanguage] */
	case 0x484d4e20: /* Hmong */
		return NewLanguage("hmn") /* Hmong [macrolanguage] */
	...
	case 0x494e5520: /* Inuktitut */
		return NewLanguage("iu") /* Inuktitut [macrolanguage] */
	case 0x49504b20: /* Inupiat */
		return NewLanguage("ik") /* Inupiaq [macrolanguage] */
	case 0x49505048: /*  */
		return NewLanguage("und-fonipa") /* Undetermined; International Phonetic Alphabet */
	case 0x49525420: /* Irish Traditional */
		return NewLanguage("ga-Latg") /* Irish;  */
	case 0x4a494920: /* Yiddish */
		return NewLanguage("yi") /* Yiddish [macrolanguage] */
	case 0x4b414c20: /* Kalenjin */
		return NewLanguage("kln") /* Kalenjin [macrolanguage] */
	case 0x4b474520: /* Khutsuri Georgian */
		return NewLanguage("und-Geok") /* Undetermined;  */
	case 0x4b4e5220: /* Kanuri */
		return NewLanguage("kr") /* Kanuri [macrolanguage] */
	case 0x4b4f4820: /* Korean Old Hangul */
		return NewLanguage("okm") /* Middle Korean (10th-16th cent.) */
	case 0x4b4f4b20: /* Konkani */
		return NewLanguage("kok") /* Konkani [macrolanguage] */
	case 0x4b4f4d20: /* Komi */
		return NewLanguage("kv") /* Komi [macrolanguage] */
	case 0x4b504c20: /* Kpelle */
		return NewLanguage("kpe") /* Kpelle [macrolanguage] */
	case 0x4b524e20: /* Karen */
		return NewLanguage("kar") /* Karen [family] */
	case 0x4b554920: /* Kui */
		return NewLanguage("uki") /* Kui (India) */
	case 0x4b555220: /* Kurdish */
		return NewLanguage("ku") /* Kurdish [macrolanguage] */
	case 0x4c554820: /* Luyia */
		return NewLanguage("luy") /* Luyia [macrolanguage] */
	case 0x4c564920: /* Latvian */
		return NewLanguage("lv") /* Latvian [macrolanguage] */
	case 0x4d415720: /* Marwari */
		return NewLanguage("mwr") /* Marwari [macrolanguage] */
	case 0x4d4c4720: /* Malagasy */
		return NewLanguage("mg") /* Malagasy [macrolanguage] */
	case 0x4d4c5920: /* Malay */
		return NewLanguage("ms") /* Malay [macrolanguage] */
	case 0x4d4e4720: /* Mongolian */
		return NewLanguage("mn") /* Mongolian [macrolanguage] */
	case 0x4d4e4b20: /* Maninka */
		return NewLanguage("man") /* Mandingo [macrolanguage] */
	case 0x4d4f4c20: /* Moldavian */
		return NewLanguage("ro-MD") /* Romanian; Moldova */
	case 0x4d594e20: /* Mayan */
		return NewLanguage("myn") /* Mayan [family] */
	case 0x4e414820: /* Nahuatl */
		return NewLanguage("nah") /* Nahuatl [family] */
	case 0x4e455020: /* Nepali */
		return NewLanguage("ne") /* Nepali [macrolanguage] */
	case 0x4e495320: /* Nisi */
		return NewLanguage("njz") /* Nyishi */
	case 0x4e4f5220: /* Norwegian */
		return NewLanguage("no") /* Norwegian [macrolanguage] */
	case 0x4f4a4220: /* Ojibway */
		return NewLanguage("oj") /* Ojibwa [macrolanguage] */
	case 0x4f524f20: /* Oromo */
		return NewLanguage("om") /* Oromo [macrolanguage] */
	case 0x50415320: /* Pashto */
		return NewLanguage("ps") /* Pashto [macrolanguage] */
	case 0x50475220: /* Polytonic Greek */
		return NewLanguage("el-polyton") /* Modern Greek (1453-); Polytonic Greek */
	case 0x50524f20: /* Provençal / Old Provençal */
		return NewLanguage("pro") /* Old Provençal (to 1500) */
	case 0x51554820: /* Quechua (Bolivia) */
		return NewLanguage("quh") /* South Bolivian Quechua */
	case 0x51555a20: /* Quechua */
		return NewLanguage("qu") /* Quechua [macrolanguage] */
	case 0x51564920: /* Quechua (Ecuador) */
		return NewLanguage("qvi") /* Imbabura Highland Quichua */
	case 0x51574820: /* Quechua (Peru) */
		return NewLanguage("qwh") /* Huaylas Ancash Quechua */
	case 0x52414a20: /* Rajasthani */
		return NewLanguage("raj") /* Rajasthani [macrolanguage] */
	case 0x524f5920: /* Romany */
		return NewLanguage("rom") /* Romany [macrolanguage] */
	...
	case 0x53595245: /* Syriac, Estrangela script-variant (equivalent to ISO 15924 'Syre') */
		return NewLanguage("und-Syre") /* Undetermined;  */
	case 0x5359524a: /* Syriac, Western script-variant (equivalent to ISO 15924 'Syrj') */
		return NewLanguage("und-Syrj") /* Undetermined;  */
	case 0x5359524e: /* Syriac, Eastern script-variant (equivalent to ISO 15924 'Syrn') */
		return NewLanguage("und-Syrn") /* Undetermined;  */
	case 0x544d4820: /* Tamashek */
		return NewLanguage("tmh") /* Tamashek [macrolanguage] */
	case 0x544f4420: /* Todo */
		return NewLanguage("xwo") /* Written Oirat */
	case 0x5a484820: /* Chinese, Traditional, Hong Kong SAR */
		return NewLanguage("zh-HK") /* Chinese [macrolanguage]; Hong Kong */
	case 0x5a485320: /* Chinese, Simplified */
		return NewLanguage("zh-Hans") /* Chinese [macrolanguage];  */
	case 0x5a485420: /* Chinese, Traditional */
		return NewLanguage("zh-Hant") /* Chinese [macrolanguage];  */
	case 0x5a48544d: /* Chinese, Traditional, Macao SAR */
		return NewLanguage("zh-MO") /* Chinese [macrolanguage]; Macao */
	case 0x5a5a4120: /* Zazaki */
		return NewLanguage("zza") /* Zazaki [macrolanguage] */
	default:
		return ""
	}
}
