...
var combiningClasses = [256]*unicode.RangeTable{
	0: {
		...
		R32: []unicode.Range32{
			...
			{Lo: 0x1f300, Hi: 0x1f6d5, Stride: 1},
			...
			{Lo: 0x20000, Hi: 0x2a6d6, Stride: 42710},
	...
	7: {
		...
		R32: []unicode.Range32{
			...
			{Lo: 0x11d42, Hi: 0x1e94a, Stride: 52232},
		},
	},
	8: {
		R16: []unicode.Range16{
