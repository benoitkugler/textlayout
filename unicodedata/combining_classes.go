...
var combiningClasses = [256]*unicode.RangeTable{
	...
	9: {
		R16: []unicode.Range16{
			...
			{Lo: 0x103a, Hi: 0x10a3, Stride: 105},
			{Lo: 0x1104, Hi: 0x1107, Stride: 3},
			{Lo: 0x110b, Hi: 0x1113, Stride: 8},
			{Lo: 0x111c, Hi: 0x1123, Stride: 7},
			{Lo: 0x112e, Hi: 0x1134, Stride: 6},
			{Lo: 0x1144, Hi: 0x114c, Stride: 8},
			{Lo: 0x115b, Hi: 0x116b, Stride: 8},
			{Lo: 0x1172, Hi: 0x1183, Stride: 17},
			{Lo: 0x119e, Hi: 0x11a3, Stride: 5},
			{Lo: 0x11a4, Hi: 0x11a9, Stride: 5},
			{Lo: 0x11c3, Hi: 0x11d4, Stride: 17},
			{Lo: 0x11d9, Hi: 0x1714, Stride: 1339},
